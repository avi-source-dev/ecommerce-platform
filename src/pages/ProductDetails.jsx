        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          ...
          {selectedProduct.size && (
            <div>
              ...
              {selectedProduct.size.map((item) => (
                <button className="m-2 bg-amber-300">{item}</button>
              ))}
            </div>
          )}
          ...
          <div className="flex items-center">
            <div className="m-6">
              ...
              {selectedProduct.stock && (
                <button
                  className="w-full md:w-fit px-8 py-3 bg-green-600 hover:bg-green-700 active:scale-95 text-white font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg ml-4"
